...
const ButtonCard: React.FC<{
  ...
  return (
    ...
    >
      <Button
        variant={variant}
        leftIcon={leftIcon as IconName | undefined}
        rightIcon={rightIcon as IconName | undefined}
      >
        {children}
      </Button>
      <div style={{ textAlign: 'center' }}>
        ...
        >
          {label}
          {copied && (
            <span style={{ marginLeft: cssVar.spacing(2), color: 'var(--ai-color-accent-green)' }}>
              ✓
            </span>
          )}
        </div>
      ...
      <div style={{ padding: cssVar.spacing(12) }}>
        ...
        <section style={{ marginBottom: cssVar.spacing(32) }}>
          <p style={{ marginBottom: cssVar.spacing(12), color: 'var(--ai-color-text-secondary)' }}>
            Versatile, accessible buttons for actions and interactions. Click any button card to
            copy its code.
          </p>
          ...
          <div style={{ marginBottom: cssVar.spacing(24) }}>
            ...
            >
              ...
              <ButtonCard variant="secondary" label="Secondary" description="Alternative actions">
                Learn More
              </ButtonCard>
...
>
  <App />
                ...
                <p style={{ marginTop: cssVar.spacing(6), margin: 0 }}>
                  All components will automatically use your brand colors! The system generates
                  hover/active states and ensures WCAG AA accessible contrast ratios.
                </p>
              </div>
            </Card>
          </div>
        ...
        <section style={{ marginBottom: cssVar.spacing(32) }}>
          <h2
            style={{ fontSize: 'var(--ai-font-size-heading-sm)', marginBottom: cssVar.spacing(8) }}
          >
            Interactive States
          </h2>
          <p style={{ marginBottom: cssVar.spacing(12), color: 'var(--ai-color-text-secondary)' }}>
        ...
        <section style={{ marginBottom: '64px' }}>
          ...
          <div style={{ display: 'grid', gap: '32px' }}>
            ...
            <div>
              ...
              >
                Tertiary Icon Buttons (With Background)
              </h3>
              <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        <section style={{ marginBottom: '64px' }}>
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <div style={{ display: 'grid', gap: '16px' }}>
              ...
              >
                ...
                >
                  The <code>disabled</code> attribute removes the button from keyboard navigation
                  and prevents all interactions.
                </div>
                <div
                  style={{
                    backgroundColor: 'var(--ai-color-bg-tertiary)',
              ...
              >
                ...
                <div style={{ fontSize: '14px', color: 'var(--ai-color-text-secondary)' }}>
                  Try tabbing through the buttons on this page - you'll see focus indicators for
                  keyboard navigation.
                </div>
              </div>
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <div style={{ display: 'grid', gap: '16px' }}>
              ...
              >
                <div style={{ fontWeight: 600, marginBottom: '8px' }}>Icons for visual clarity</div>
                <div
                  style={{
                    fontSize: '14px',
                    marginBottom: '12px',
              ...
              >
                ...
                >
                  Use color prop to convey meaning: success for confirmations, error for destructive
                  actions.
                </div>
                <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <section style={{ marginBottom: '32px' }}>
          ...
          <PropsTable
            ...
            rows={[
              ...
              },
              {
                name: 'leftIcon',
                description:
                  'Icon to display before the button text (IconName). See Icon component for available icons. Example: leftIcon="plus-circle-add"',
              },
              {
                name: 'rightIcon',
                description:
                  'Icon to display after the button text (IconName). Commonly used for directional actions. Example: rightIcon="arrow-right-sm"',
              },
              {
                name: 'iconOnly',
                description:
                  'Render as a circular 44×44 icon-only button (IconName). When set, children are ignored and aria-label is REQUIRED for accessibility.',
              },
              {
                name: 'disabled',
                description:
                  'Disables the button (boolean), preventing interaction and removing it from keyboard navigation. Default: false',
              },
              {
                name: 'children',
              ...
              },
              {
                name: 'aria-label',
                description:
                  'Accessible label for screen readers (string). REQUIRED when using iconOnly. Provides context for icon-only buttons.',
              },
              {
                name: 'type',
          ...
          >
            <strong>Note:</strong> Button also supports all standard HTML button attributes
            (disabled, type, onClick, onFocus, onBlur, etc.) via{' '}
