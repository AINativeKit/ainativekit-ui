...
/>`}
    ...
    {/* Key Features */}
    <section style={{ marginBottom: '64px' }}>
      <h2 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '24px' }}>Key Features</h2>
      <div
        style={{
          display: 'grid',
    ...
    <section style={{ marginBottom: '48px' }}>
      <h2 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '24px' }}>Component Props</h2>
      <PropsTable
        hideThemeColumn
        rows={[
          {
          ...
          },
          {
            name: 'features',
            description:
              'Array of feature items (strings or icon-label pairs). Can include pricing like "$$$", "$$", "$"',
          },
          {
            name: 'description',
    ...
    {/* Use Cases */}
    <section style={{ marginBottom: '48px' }}>
      <h2 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '24px' }}>Use Cases</h2>
      <div
        style={{
          background: 'var(--ai-color-bg-secondary)',
          border: '1px solid var(--ai-color-border)',
      ...
      >
        <ul style={{ margin: 0, paddingLeft: '20px' }}>
          ...
          <li>
            <strong>Product Catalogs:</strong> Display products with images, prices, and features in
          ...
          <li>
            <strong>Content Discovery:</strong> Browse articles, videos, or other content with rich
            previews
          </li>
          <li>
