...
export const iconMetadata = {
  ...
  'suitcase-filled-work-business': { category: 'account-user', fileName: 'suitcase-filled-work-business' },
  ...
  'image-square-picture-library': { category: 'chat-tools', fileName: 'image-square-picture-library' },
  ...
  'quote-reply-filled-quote-xs': { category: 'chat-tools', fileName: 'quote-reply-filled-quote-xs' },
  ...
  'sound-on-read-out-loud-speaker': { category: 'chat-tools', fileName: 'sound-on-read-out-loud-speaker' },
  ...
  'sidebar-menu-mobile-badge-cutout': { category: 'interface', fileName: 'sidebar-menu-mobile-badge-cutout' },
  'unlink': { category: 'interface', fileName: 'unlink' },
  'x-circle-crossed-close': { category: 'interface', fileName: 'x-circle-crossed-close' },
  'x-circle-filled-crossed-close': { category: 'interface', fileName: 'x-circle-filled-crossed-close' },
  ...
  'internal-knowledge-optimized-for-circle': { category: 'misc', fileName: 'internal-knowledge-optimized-for-circle' },
  ...
  'triangle-exclamation-error-warning': { category: 'settings', fileName: 'triangle-exclamation-error-warning' },
  'triangle-exclamation-filled-error-warning': { category: 'settings', fileName: 'triangle-exclamation-filled-error-warning' },
  'tuning-fork': { category: 'settings', fileName: 'tuning-fork' },
  'upgrade': { category: 'settings', fileName: 'upgrade' },
  'warning-filled-wrap-centered-for-circle': { category: 'settings', fileName: 'warning-filled-wrap-centered-for-circle' },
  'warning-wrap-centered-for-circle': { category: 'settings', fileName: 'warning-wrap-centered-for-circle' },
  'whisper-auto-submit': { category: 'settings', fileName: 'whisper-auto-submit' }} as const satisfies Record<IconName, { category: IconCategory; fileName: string }>;
